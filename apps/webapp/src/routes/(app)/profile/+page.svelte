...
<div>
	<!-- header -->
	<div class="relative bg-muted border border-input rounded-b-md p-1 h-44 flex flex-col justify-between">
		<div
		...
		<div class="z-10 mt-auto p-1 flex items-end justify-between">
			...
			<div class="px-1 text-sm flex gap-2.5 items-center">
